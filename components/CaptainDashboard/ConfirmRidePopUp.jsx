...
const ConfirmRidePopUp = (props) => {
  ...
  const submitHander = async (e) => {
    ...
    const response = await axios.get(
      `${process.env.NEXT_PUBLIC_API_BASE_URL}rides/start-ride`,
      {
        params: {
  ...
  return (
    <div>
      ...
      <div className="flex items-center justify-between p-3 border-2 border-violet-700 rounded-lg mt-4">
